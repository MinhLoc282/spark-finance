...
export interface Borrow {
  ...
  >,
  'getDepositId' : ActorMethod<[], [] | [SharedDepositType]>,
  'getDepositIdPerUser' : ActorMethod<[Principal], [] | [SharedDepositType]>,
...
export interface SharedDepositType {
  'startTime' : Time,
  'duration' : bigint,
  'isUsing' : boolean,
  'reserve0' : bigint,
