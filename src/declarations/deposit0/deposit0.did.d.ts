...
export interface Deposit {
  ...
  'calculateAPY' : ActorMethod<[Principal], number>,
  ...
  'getAccountInfo' : ActorMethod<[], [bigint, bigint, bigint, number]>,
  'getAverageLock' : ActorMethod<[Principal], [] | [bigint]>,
  'getCirculatingSupply' : ActorMethod<[], bigint>,
  'getCurrentMultiplier' : ActorMethod<[DepositType], bigint>,
  'getCurrentMultiplierBaseOnTimestamp' : ActorMethod<
    [DepositType, Time],
    bigint
  >,
  'getDepositId' : ActorMethod<[Principal], [] | [Array<DepositType>]>,
  'getDepositStats' : ActorMethod<
    [],
    [
      [] | [number],
      bigint,
