export const idlFactory = ({ IDL }) => {
  ...
  const Deposit = IDL.Service({
    ...
    'calculateAPY' : IDL.Func([IDL.Principal], [IDL.Float64], []),
    ...
    'getCurrentMultiplier' : IDL.Func([DepositType], [IDL.Nat], []),
    'getCurrentMultiplierBaseOnTimestamp' : IDL.Func(
        [DepositType, Time],
        [IDL.Nat],
        [],
      ),
    ...
    'getTotalInterestForUser' : IDL.Func(
