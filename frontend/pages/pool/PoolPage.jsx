...
function PoolPage() {
  ...
  return (
    <div className={styles.PageContainer}>
      <div className={styles.Heading}>Liquidity Pool</div>
      <div>
              ...
              pairInfo.token0 === token0.canisterId ? ckBTC
                : pairInfo.token0 === token1.canisterId ? ckETH
                  : ''
                    ...
                    />
                    <div style={{ alignSelf: 'center' }}>
                      {(parseFloat(pairInfo.reserve0) / 10 ** 18).toFixed(2)}
                      {' '}
              ...
              pairInfo.token1 === token0.canisterId ? ckBTC
                : pairInfo.token1 === token1.canisterId ? ckETH
                  : pairInfo.token1 === deposit0.canisterId ? dckBTC
                    ...
                    />
                    <div style={{ alignSelf: 'center' }}>
                      {(parseFloat(pairInfo.reserve1) / 10 ** 18).toFixed(2)}
                      {' '}
            ...
            : ethDepPairInfo.token0 === deposit1.canisterId ? dckETH
              ...
              <div style={{ alignSelf: 'center' }}>
                {ethDepPairInfo
                  ? (
                    ethDepPairInfo.token0 === token1.canisterId ? 'ckETH'
                      : ethDepPairInfo.token0 === deposit1.canisterId ? 'd.ckETH'
                        : ''
                  )
                  : 'ckETH'}
              </div>
            ...
            : ethDepPairInfo.token1 === deposit1.canisterId ? dckETH
              ...
              <div style={{ alignSelf: 'center' }}>
                {ethDepPairInfo
                  ? (
                    ethDepPairInfo.token1 === token1.canisterId ? 'ckETH'
                      : ethDepPairInfo.token1 === deposit1.canisterId ? 'd.ckETH'
                        : ''
                  )
                  : 'd.ckETH'}
              </div>
              ...
              ethDepPairInfo.token0 === token1.canisterId ? ckETH
                : ethDepPairInfo.token0 === deposit1.canisterId ? dckETH
                  : ''
                    ...
                    />
                    <div style={{ alignSelf: 'center' }}>
                      {(parseFloat(ethDepPairInfo.reserve0) / 10 ** 18).toFixed(2)}
                      {' '}
              ...
              ethDepPairInfo.token1 === token1.canisterId ? ckETH
                : ethDepPairInfo.token1 === deposit1.canisterId ? dckETH
                  : ''
                    ...
                    />
                    <div style={{ alignSelf: 'center' }}>
                      {(parseFloat(ethDepPairInfo.reserve1) / 10 ** 18).toFixed(2)}
                      {' '}
            ...
            <div style={{ display: 'flex', gap: '10px' }}>
              ...
              <div style={{ alignSelf: 'center' }}>
                {btcDepPairInfo
                  ? (
                    btcDepPairInfo.token0 === token0.canisterId ? 'ckBTC'
                      : btcDepPairInfo.token0 === deposit0.canisterId ? 'd.ckBTC'
                        : ''
                  )
                  : 'ckBTC'}
              </div>
            ...
            <div style={{ display: 'flex', gap: '10px' }}>
              ...
              <div style={{ alignSelf: 'center' }}>
                {btcDepPairInfo
                  ? (
                    btcDepPairInfo.token1 === token0.canisterId ? 'ckBTC'
                      : btcDepPairInfo.token1 === deposit0.canisterId ? 'd.ckBTC'
                        : ''
                  )
                  : 'd.ckBTC'}
              </div>
              ...
              btcDepPairInfo.token0 === token0.canisterId ? ckBTC
                : btcDepPairInfo.token0 === deposit0.canisterId ? dckBTC
                  : ''
                    ...
                    />
                    <div style={{ alignSelf: 'center' }}>
                      {(parseFloat(btcDepPairInfo.reserve0) / 10 ** 18).toFixed(2)}
                      {' '}
              ...
              btcDepPairInfo.token1 === token0.canisterId ? ckBTC
                : btcDepPairInfo.token1 === deposit0.canisterId ? dckBTC
                  : ''
                    ...
                    />
                    <div style={{ alignSelf: 'center' }}>
                      {(parseFloat(btcDepPairInfo.reserve1) / 10 ** 18).toFixed(2)}
                      {' '}
